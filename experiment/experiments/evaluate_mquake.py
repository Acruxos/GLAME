...
from experiments.py.eval_utils_mquake import compute_rewrite_quality_mquake, compute_rewrite_quality_single_hops
    ...
    for chunk in chunks(zipped_lists, num_edits):
        ...
        for record in record_chunks:
            ...
            metrics = {
                ...
                "time": exec_time,
                "portability": compute_rewrite_quality_mquake(
                    model=edited_model,
                    tok=tok,
                    record=record,
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--alg_name",
        choices=["MEMIT", "ROME", "FT", "MEND", "GLAME"],
        default="GLAME",
    ...
    parser.add_argument(
        "--ds_name",
        choices=["mcf", "cf", "zsre", "cf-one-hop", "mquake"],
        default="mcf",
